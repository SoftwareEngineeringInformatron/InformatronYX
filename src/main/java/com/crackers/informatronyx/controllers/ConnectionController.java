...
public class ConnectionController {
        ...
        else
        {
            ...
            if(lo==null)
                ...
                if(le==null)
                    ...
                    sendLE(le.getId()//+le.getFileExtension()
                            ,response);
            }
        }
    ...
    private void sendLE(String leId,HttpServletResponse response){
        ...
        try {
            URI uri = new URI(AppConfig.LOOP_DOWNLOAD_LE+leId);
            ClientHttpRequest createRequest = requestfactory.createRequest(uri, HttpMethod.GET);
