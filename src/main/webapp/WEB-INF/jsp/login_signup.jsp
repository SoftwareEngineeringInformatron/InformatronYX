                ...
                <div class="container">
                    <div class="row-fluid"  >
                        ...
                        <div class="login">
                                ...
                                <input ng-model="userInfo.username"  type="text" size="20" placeholder="Username" title="Username" required>
                                <br><input ng-model="userInfo.password" type="password" size="20" placeholder="Password" title="Password" required>
                                <div class="divider"></div>
                                <div class="clearfix"></div>
                                <div class="divider"></div>
                                <button ng-click="login()" id="btn-login" type="submit" class="btn btn-primary" data-dismiss="modal"> Login </button>&nbsp;
                        ...
                        <div id="signup">
                            <div class="signup no-display">
                                ...
                                <br><input ng-model="userInfo.firstName" name="fname" id="fname" type="text" size="20" placeholder="First Name" title="First Name" required>
                                <br><input ng-model="userInfo.lastname" name="lname" id="lname" type="text" size="20" placeholder="Last Name" title="Last Name" required>
                                ...
                                <input ng-model="userInfo.username" name="uname" id="uname" type="text" size="20" placeholder="Username" title="Username" required>
                                ...
                                <button ng-click= "signup()"class="btn btn-primary" id="btn-signup"> Sign Up </button>&nbsp;
                                <button type="reset" class="btn btn-cancel" data-dismiss="modal"> Clear </button>&nbsp;&nbsp;&nbsp;
                        </div>
