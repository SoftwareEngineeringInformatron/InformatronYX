        ...
        <div class="wrapIt">
            ...
            <section id="learning-objects" class="container">
                ...
                <div class="content-row " style="text-align: center; padding-top: 50px;">
                    <form role="form">
                        <input type="text" placeholder="Student" id="student" alt="student"><br>
                        <input type="text" placeholder="Learning Object" id="lo" alt="lo"><br>
                        ...
                        <button type="button" class="btn btn-default" id="add_result_btn">Submit</button>
                    </form>
